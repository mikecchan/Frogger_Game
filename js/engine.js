...
var Engine = (function(global) {
    //console.log("Entering Engine function");
    ...
    function updateEntities(dt) {
        //console.log("Entering updateEntities(dt) function");
    ...
    function render() {
        ...
        for (row = 0; row < numRows; row++) {
            for (col = 0; col < numCols; col++) {
                ...
                //console.log("Resources.get() is " + Resources.get(rowImages[row]));
    ...
    function renderEntities() {
      //console.log("Entering renderEntities() function");
